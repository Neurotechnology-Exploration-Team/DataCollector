...
class StationaryToSelect(TestThread):
    """
    The Stationary Float To Select test that extends the TestThread class.
    ...
    def __init__(self):
        ...
        action_image_directory = os.path.join(os.path.dirname(__file__), '..', 'assets', 'select white.png')
