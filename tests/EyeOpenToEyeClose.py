...
class EyeOpenToEyeClose(TestThread):
    ...
    def __init__(self):
        ...
        self.float_label = tk.Label(TestGUI.display_window, text="Eyes Closed", font=("Helvetica", 16))
        self.image_label = tk.Label(TestGUI.display_window, text="Eyes Open", font=("Helvetica", 16))
